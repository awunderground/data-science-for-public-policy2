...
![Source: [R4DS](https://r4ds.had.co.nz/tidy-data.html)](`r here::here("tutorials", "images", "tidy-data.png")`){width=400}
...
### `r kableExtra::text_spec("Exercise", color = "#1696d2")`
...
`readr` and `read_csv()` have powerful tools for resolving parsing issues. More can be learned in the [data import section in R4DS](https://r4ds.had.co.nz/data-import.html).
