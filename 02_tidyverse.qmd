...
`readr` and `read_csv()` have powerful tools for resolving parsing issues. More can be learned in the [data import section in R4DS](https://r4ds.hadley.nz/data-import.html).
