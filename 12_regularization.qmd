...
Let's fit a linear regression model on the PDB data set. We will compare the results of multiple types of regularization throughout the course of this chapter. This see their effects, we will fit an OLS model of the PBD data set as a "baseline."
