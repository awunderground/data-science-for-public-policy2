...
Mixture distributions are often overparameterized, which means they have an exceesive number of parameters. For a univariate mixture of normals with $k$ components, we have $k$ means, $k$ standard deviations, and $k$ mixing coefficients.
