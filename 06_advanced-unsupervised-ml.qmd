...
Consider the following density plot based on real data.
...
This density looks very complicated. But what if we break this distribution into pieces. In this case, what if we broke it into two normal distributions?
...
ancestral sampling: sample z_hat, sample x_hat\|z_hat (Bishop 430)
