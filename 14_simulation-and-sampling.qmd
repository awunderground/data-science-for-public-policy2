...
The following answers the question: "What is the 10th percentile number of events to see in 10 trials when `p = 0.5`?
...
Let $T_i$ be the time between arrivales and $T_i \sim exp(\lambda_1)$
