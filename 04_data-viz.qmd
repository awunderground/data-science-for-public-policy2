...
abstract: This chapter introduces ggplot2, the tidyverse’s wildly popular data visualization package. 
format: 
  html:
    toc: true
...
recent_storms |>
  ...
  geom_polygon(data = urbnmapr::states, aes(long, lat, group = group),
