...
![A standard git workflow](images/git-branching.png)
...
![An New Pull Request](images/new-pull-request.png)


2. Then set a pull request from the branch on the right to the branch on the left. 

![](images/pull-request.png){fig-align="center"}


3. Navigate to the pull requests page and review the pull request. <br>
![](images/pull-requests.png){fig-align="center"}

4. Merge the pull request:

![](images/merge-pull-request.png){fig-align="center"}
...
GitHub offers a free and simple tool for a hosting website in a GitHub repository called [GitHub pages](https://pages.github.com/). A basic setup is to use index.html or README.md as an index to connect individual pages together whose URLs are based on their file names. 
