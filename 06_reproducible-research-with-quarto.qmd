...
We can share documents rendered with Quarto in multiple ways. 

1. We can email/share .pdf and .html documents
2. We can use GitHub pages to host .html pages as websites
3. We can host documents on [Posit Connect](https://posit.co/products/enterprise/connect/) or a cloud service like AWS
