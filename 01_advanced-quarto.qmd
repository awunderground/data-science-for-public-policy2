...
Quarto converts these plain text documents into rich output documents like these class notes. The "Render" button appears in RStudio with a `.qmd` file is open in the editor window.

Clicking the "Render" button begins the process of rednering `.qmd` files.
