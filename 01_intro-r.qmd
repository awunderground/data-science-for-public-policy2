...
All R programming will involve some base R, but much base R has been replaced with new tools that are more concise. Just know that at some point you may end up on a Stack Overflow page that looks like alphabet soup because it's in a paradigm that you have not learned. Chapter 27 of *R for Data Science (2e)* provides a great introduction to base R [@wickham_r_2023]. 
